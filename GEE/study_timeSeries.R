...
print(milk)
autoplot(milk)
#veremos algum componentes:
# tendencia
# sazonalidade
# aleatório
#ciclo (não é muito comum - não veremos isso)

dec.milk = decompose(milk)#decompondo nos componentes acima
autoplot(dec.milk$trend)
autoplot(dec.milk$seasonal)
ggseasonplot(milk)
autoplot(dec.milk$random)
autoplot(dec.milk) 

#próximo exemplo - método multiplicativo
print(AirPassengers)
autoplot(AirPassengers)
dec.air = decompose(AirPassengers, type = "multiplicative")
autoplot(dec.air)

#---------------------------------
# https://github.com/paulamacaira/live_estatidados_mar2021/blob/master/Rotina%20principal.R
# live: https://www.youtube.com/watch?v=EXy8iI-ttW0&ab_channel=EstaTiDados
# by: Paula Maiçara
...
library(fpp3)
#book: forecast principle and pratices 3
